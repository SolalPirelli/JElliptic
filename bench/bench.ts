...
function pollardRhoSuite() {
    ...
    s("Step of 2 parrallel walks over a 112-bit curve (r = 16)", () => walk2_16.step());
    s("Step of 4 parrallel walks over a 112-bit curve (r = 16)", () => walk4_16.step());
    ...
    s("1000 steps of a single walk over a 112-bit curve (r = 16)", () => {
        for (var n = 0; n < 1000; n++) {
            walk1_16.step();
        }
    });
    s("1000 steps of 2 parrallel walks over a 112-bit curve (r = 16)", () => {
        for (var n = 0; n < 1000; n++) {
            walk2_16.step();
        }
    });
    s("1000 steps of 4 parrallel walks over a 112-bit curve (r = 16)", () => {
        for (var n = 0; n < 1000; n++) {
            walk4_16.step();
        }
    });
    s("1000 steps of 8 parrallel walks over a 112-bit curve (r = 16)", () => {
        for (var n = 0; n < 1000; n++) {
            walk8_16.step();
        }
    });
    s("1000 steps of 16 parrallel walks over a 112-bit curve (r = 16)", () => {
        for (var n = 0; n < 1000; n++) {
            walk16_16.step();
        }
    });
    s("1000 steps of 32 parrallel walks over a 112-bit curve (r = 16)", () => {
        for (var n = 0; n < 1000; n++) {
            walk32_16.step();
        }
    });
    s("1000 steps of 64 parrallel walks over a 112-bit curve (r = 16)", () => {
        for (var n = 0; n < 1000; n++) {
            walk64_16.step();
        }
    });
    ...
    s("1000 steps of a single walk over a 112-bit curve (r = 64)", () => {
        for (var n = 0; n < 1000; n++) {
            walk1_64.step();
        }
    });
    s("Step of a single walk over a 112-bit curve (r = 256)", () => walk1_256.step());
    s("1000 steps of a single walk over a 112-bit curve (r = 256)", () => {
        for (var n = 0; n < 1000; n++) {
            walk1_256.step();
        }
    });
    ...
    s("1000 steps of 64 parrallel walks over a 112-bit curve (r = 64)", () => {
        for (var n = 0; n < 1000; n++) {
            walk64_64.step();
        }
    });
    s("Step of 64 parrallel walks over a 112-bit curve (r = 256)", () => walk64_256.step());
    s("1000 steps of 64 parrallel walks over a 112-bit curve (r = 256)", () => {
        for (var n = 0; n < 1000; n++) {
            walk64_256.step();
        }
    });

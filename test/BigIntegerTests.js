...
define(["require", "exports", "BigInteger"], function(require, exports, BigInteger) {
    ...
    (function (BigIntegerTests) {
        ...
        function mul(s1, s2, result) {
            ...
            if (s1 != "0") {
                op("div", result, s1, s2, function (b1, b2) {
                    return b1.div(b2);
                });
            }
            if (s1 != s2 && s2 != "0") {
                op("div", result, s2, s1, function (b1, b2) {
                    return b1.div(b2);
                });
            }
        }
        ...
        function mod(s1, s2, result) {
            op("mod", s1, s2, result, function (b1, b2) {
                return b1.mod(b2);
            });
        }
        ...
        function eq(s1, s2, result) {
            binOp("eq", s1, s2, result, function (b1, b2) {
                return b1.eq(b2);
            });
            if (s1 != s2) {
                binOp("eq", s2, s1, result, function (b1, b2) {
                    return b1.eq(b2);
                });
            }
        }
